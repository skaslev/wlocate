...
static long *I,                 /* group array, ultimately suffix array.*/
...
static void update_group(long *pl, long *pm)
{
   long g;
...
static void select_sort_split(long *p, long n) {
   long *pa, *pb, *pi, *pn;
   long f, v, tmp;
...
static long choose_pivot(long *p, long n) {
   long *pl, *pm, *pn;
   long s;
...
static void sort_split(long *p, long n)
{
...
static void bucketsort(long *x, long *p, long n, long k)
{
   long *pi, i, c, d, g;
...
/* Transforms the alphabet of x by attempting to aggregate several symbols into
   ...
   LONG_MAX, the maximum number of symbols are aggregated into one.

   Output: Returns an integer j in the range 1...q representing the size of the
   new alphabet. If j<=n+1, the alphabet is compacted. The global variable r is
   set to the number of old symbols grouped into one. Only x[n] is 0.*/

static long transform(long *x, long *p, long n, long k, long l, long q)
{
